...
class JetEmbed(nn.Module):
    """ Jet to jet patch Embedding
    """
    def __init__(self, jet_size=20, patch_size=3, in_dim=4, embed_dim=768):
        super().__init__()
        num_patches = (jet_size // patch_size)
